...
image:https://img.shields.io/packagist/v/rich-id/cookies-regulation-bundle-bundle[link="https://packagist.org/packages/rich-id/cookies-regulation-bundle-bundle",window="_blank"]
